...
Разработать *RESTful* сервис для работы с БД, предоставляющий открытый *API*, с использованием спецификации *JAX-RS*. Разработать документацию к *API* в [*Postman*](https://www.postman.com/) ([ссылка на краткую теорию](./Postman theory.md)). Варианты БД:

...
Разработать *RESTful* сервис для работы с БД, предоставляющий открытый *API*, с использованием спецификации *JAX-RS*. Разработать документацию к *API* в *Postman*. Варианты БД:
...
- для работы с БД использовать фреймворк *Hibernate* (или классический *JDBC*)
